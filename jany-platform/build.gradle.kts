...
//        api(project(":jany-jooq-codegen"))
        ...
        api("io.ebean:persistence-api:${p["ebeanPersistenceApiVersion"]}")
        api("io.ebean:ebean-annotation:${p["ebeanAnnotationVersion"]}")
        api("io.ebean:ebean-types:${p["ebeanTypesVersion"]}")
        ...
        api("io.ebean:ebean-test-containers:${p["ebeanTestContainersVersion"]}")
        ...
        api("io.ebean:ebean-joda-time:${p["ebeanVersion"]}")
