...
public class ErrorMappings {
    ...
    private static final Map<String, DefinedErrorInfo> INTERNAL = new HashMap<>();

    static {
        // start security
        INTERNAL.put(
            "org.springframework.security.core.userdetails.UsernameNotFoundException",
            DefinedErrorInfo.of("LOGIN_ERROR_BAD_CREDENTIALS", 401,
        ...
        INTERNAL.put(
            ...
            DefinedErrorInfo.of("LOGIN_ERROR_DISABLED", 401,
                HttpStatus.UNAUTHORIZED.getReasonPhrase())
        );
        // end security
